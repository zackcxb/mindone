...
from .models.transformers.flux_transformer_withDeltaCache import transformer_blocks_withcache, single_transformer_blocks_withcache, flux_transformer2d_construct
...
class FluxPipeline(
    ...
    def __init__(
        ...
        self.transformer_skip = json.load(open("config/cache_params.json", "r"))["transformer_skip"]
        self.single_transformer_skip = json.load(open("config/cache_params.json", "r"))["single_transformer_skip"]
        self.transformer_skip = [(0,0)]+self.transformer_skip+[0,0]
        self.single_transformer_skip = [(0,0)]+self.single_transformer_skip+[0,0]
        self._register_func()
    def _register_func(self):
        self.transformer.construct = MethodType(flux_transformer_construct, self.transformer)
