...
from examples.dit_infer_acceleration.FBCache_ms.pipeline_flux import FluxPipeline
import os
import argparse
import time
import numpy as np
...
def arg_parse():
    ...
    parser.add_argument("--save_params_path", type=str, default=os.path.join(parent_path, "config/cache_usage_history.json"), help="Save cache usage history path")
