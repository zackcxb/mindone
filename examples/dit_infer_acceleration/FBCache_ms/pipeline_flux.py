...
from mindone.diffusers.pipelines.flux.pipeline_output import FluxPipelineOutput

from FBCache_ms.models.transformer_flux_withFBCache import FBCache_transformer_construct, CacheContext
...
class FluxPipeline(
    ...
    def _register_func(self):
        self.transformer.construct = MethodType(FBCache_transformer_construct, self.transformer)
    ...
    def __call__(
        ...
        bs, seq, _ = latents.shape
        self.transformer.cache_context = CacheContext(bs, seq, self.transformer.inner_dim, 
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                #     neg_noise_pred, neg_hidden_states_residual, neg_first_hidden_states_residual = self.transformer(
                #         hidden_states=latents,
                #         timestep=timestep / 1000,
                #         guidance=guidance,
